...
### Changed
- downloading data for downtime statistics improved


## [2021.2.3.28] - 2021-06-28

### Changed
- data page: user for orders and downtimes downloaded from orderRecord and userRecord
- workplaces page: user downloaded from orderRecord
...
- downtime for statistics data preparation and sending to frontend
